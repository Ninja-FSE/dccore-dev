...
SETTINGS_CATEGORIES = (
    ...
    ("slots-queue",   "Slots & queue",         ["MAX_DCC_SLOTS", "MAX_USER_QUEUE", "MAX_GLOBAL_QUEUE",
                                                ...
                                                "MAX_FETCH_FILE_SIZE", "MAX_LIST_TEXT_SIZE", "REHASH_TRANSFER_WAIT", "AUTO_REFETCH_LISTS", "AUTO_REFETCH_INTERVAL_HOURS",
...
SETTINGS_LABELS = {
    ...
    "DCC_BLOCK_SIZE": "Bytes per pass of a transfer (mIRC calls it packet size)",
