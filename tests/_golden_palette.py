...
announce.py and list.py, with the clock frozen. These are the bytes the
classic theme must still produce: a refactor of the look that alters one
of them is not a refactor.
"""
...
GOLDEN = {
    ...
    'send_debug': [
        'PRIVMSG #flac-serv :\x0304,05 \x0310,10 \x0301,00 [00:13:20] \x02DEBUG\x02 \x0310,10 \x0304,05 \x0301,00 \x02Category\x02: \x0314[INFO]\x0f\x0301,00 \x0310,10 \x0304,05 \x0301,00 Log: a debug line \x0310,10 \x0304,05 \x0f\r\n',
    ],
    ...
    'send_transfer_complete': [
        'PRIVMSG #mp3passion :\x0304,05 \x0310,10 \x0301,00 \x02\x0303Sent\x02\x0301,00: \x02Enter Sandman.flac\x02 \x0310,10 \x0304,05 \x0301,00 To: \x02\x0303dave\x02 \x0310,10 \x0304,05 \x0301,00 Total Sent: \x02\x0303100 Files (200.0B)\x02 \x0310,10 \x0304,05 \x0301,00 Yesterday: \x02\x03043 Files\x02 \x0310,10 \x0304,05 \x0301,00 Today: \x02\x03045 Files\x02 \x0312[as of 12:13 am] \x0310,10 \x0304,05 \x0301,00 Speed: \x02\x0303500.0k/s\x02 \x0310,10 \x0304,05 \r\n',
    ],
}
