...
PLAIN_HELP = {
    ...
    'LIST_AUDIO_INFO_THREADS': 'How many audio files are read at once for their length and quality. On a network drive most of the time is waiting, so reading several at once is much faster. 1 to 64.',
