...
PLAIN_HELP = {
    ...
    'LIST_AUDIO_INFO_THREADS': 'How many audio files are read at once for their length and quality. On a network drive most of the time is waiting, so more at once is faster: try 64 there. The rebuild says the rate it got, to compare. 1 to 128.',
