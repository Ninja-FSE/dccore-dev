...
system. On the first run it opens the setup page in your browser - nickname,
server, channels, your nick, the password, the music folder, each with an
explanation beside it - and starts the bot the moment you save. (No browser,
or you said no to installing Flask? The same questions are asked in the
terminal instead.) Every run after that checks the setup and starts the bot:
